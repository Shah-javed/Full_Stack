...
PHONE_METADATA_GP = PhoneMetadata(
    ...
    general_desc=PhoneNumberDesc(
        national_number_pattern="(?:590|(?:69|80)\\d|976)\\d{6}", possible_length=(9,)
    ),
    fixed_line=PhoneNumberDesc(
        national_number_pattern="590(?:0[1-68]|[14][0-24-9]|2[0-68]|3[1289]|5[3-579]|6[0-289]|7[08]|8[0-689]|9\\d)\\d{4}",
    ...
    voip=PhoneNumberDesc(
        national_number_pattern="976[01]\\d{5}",
