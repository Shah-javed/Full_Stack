...
PHONE_METADATA_MU = PhoneMetadata(
    ...
    general_desc=PhoneNumberDesc(
        national_number_pattern="(?:5|8\\d\\d)\\d{7}|[2-468]\\d{6}",
    ...
    mobile=PhoneNumberDesc(
        national_number_pattern="5(?:4(?:2[1-389]|7[1-9])|87[15-8])\\d{4}|5(?:2[5-9]|4[3-689]|[57]\\d|8[0-689]|9[0-8])\\d{5}",
    ...
    number_format=[
        ...
        NumberFormat(
            pattern="(\\d{4})(\\d{4})", format="\\1 \\2", leading_digits_pattern=["5"]
        ),
        NumberFormat(
