...
PHONE_METADATA_MM = PhoneMetadata(
    ...
    mobile=PhoneNumberDesc(
        national_number_pattern="(?:17[01]|9(?:2(?:[0-4]|[56]\\d\\d)|(?:3(?:[0-36]|4\\d)|(?:6\\d|9[4-8])\\d|7(?:3|40|[5-9]\\d)|8(?:78|[89]\\d))\\d|4(?:(?:[0245]\\d|[1379])\\d|88)|5[0-6])\\d)\\d{4}|9[69]1\\d{6}|9(?:[68]\\d|9[089])\\d{5}",
        example_number="92123456",
        possible_length=(7, 8, 9, 10),
    ),
    toll_free=PhoneNumberDesc(
        national_number_pattern="80080(?:[01][1-9]|2\\d)\\d{3}",
